...
<body style="	font-family: Century Gothic;">
	...
	<?php
		...
		?>
		<form method="get" action="racoes.php" name="filtro">
		...
		<table align="left" style="margin-left:50px; margin-bottom:30px">
			<tr>
				<td>
					<div id="content">
						<br>
						<h1> <b> &nbsp Rações </b> </h1>
						<br>
					</div>

					<?php
					include_once('../../BD/produtos.php');
					retornarRacoes($where, $where2);
					?>
		...
		<div align="left">
			<br>
			<h3><b> Nome da Ração </b></h3> <br>
			<h4> BREVE DESCRIÇÃO DA RAÇÃO </h4><br>
			<h3>Valor:<b> R$ 00,00 </b>
				<h3><br>
					<br><br><br>
		</div>-->

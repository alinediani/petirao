...
<body style="	font-family: Century Gothic;">
	<?php
	include_once("../../NAVBAR/navbar2.php");
	?>
	...
	<div class="container-fluid col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<form method="get" action="acessorios.php" name="filtro">
		...
		<table align="left" style="margin-left:50px; margin-bottom:30px">
			<tr>
				<td>
					<div id="content">
						<br>
						<h1> <b> &nbsp Acessórios </b> </h1>
						<br>
					</div>

					<form method="POST" action="../../CARRINHO/compra.php">
					<?php
					include_once('../../BD/produtos.php');
					retornarAcessorios($where, $where2);
					?>
					</form>
			...
			if (checksession2() == 0) {
				...
				echo '<div id="chamada_cadastro" class="card text-center bg-warning border-light col-lg-12 col-md-12 col-sm-12 col-xs-12" id="chamada_cad1"></div>';
			}
			?>

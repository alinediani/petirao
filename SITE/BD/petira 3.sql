...
INSERT INTO `petiraco`.`produto` (`nm`, `tipo`, `val`, `dtval`, `ds`, `idforn`) VALUES ('Prod1', 'A', '12,99', '2019-09-09', 'Descriçãoo', '1');
INSERT INTO `petiraco`.`produto` (`nm`, `tipo`, `val`, `dtval`, `ds`, `idforn`) VALUES ('Produtinn ', 'A', '30,77', '2019-10-10', 'Opaaa', '1');
INSERT INTO `petiraco`.`produto` (`nm`, `tipo`, `val`, `dtval`, `ds`, `idforn`) VALUES ('Coleira', 'A', '25.99', '2019-11-10', 'Deshu', '1');
INSERT INTO `petiraco`.`produto` (`nm`, `tipo`, `val`, `dtval`, `ds`, `idforn`) VALUES ('Tesssstee', 'R', '199.99', '2019-09-01', 'hidhifdi', '1');

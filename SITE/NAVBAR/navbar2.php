		...
		text-align : center;
			...
			<div class = "container-fluid" id = "cabeçalho1" style = "background-color:RoyalBlue" style="font-family: Century Gothic;">
				...
				<nav class = "navbar navbar-expand-xl navbar-light" style = "background-color: RoyalBlue;">
					<a class = "navbar-brand" href = "../..\HOME\home.php"> <img src = "img/LogoPetirão.jpg" width = "300" height = "150"> </a>
					...
					<div class = "collapse navbar-collapse" id = "navBar">
						...
						<ul class = "navbar-nav mr-auto">
							<li class = "nav-item"> <a class = "nav-link" href = "..\..\HOME\home.php" style = "color:white"> &nbsp; Home &nbsp;</a> </li>
